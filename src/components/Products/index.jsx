...
function Products() {
  ...
  const { basket, addBasket, removeBasket, countNumber } =
              ...
              {basket.map((x) => (
                <ul key={x.id}>
                  <div className="card_img">
                    ...
                    <p className="del_card">
                      <i
                        onClick={() => removeBasket(x.id)}
                        className="remove_basket_card fa-solid fa-xmark"
                      ></i>
                    </p>
                  </div>
            ...
            <div className="wishlist_card">
              {wishlist.map((x) => (
                <ul key={x.id}>
                  <div className="card_img">
                    <img src={x.images} alt="" />
                    <p onClick={() => removeWish(x.id)} className="del_card">
                      <i className="remove_basket_card fa-solid fa-xmark"></i>
                    </p>
                  </div>
                  <div className="card_info">
                    <li>{x.model}</li>
